...
$data = mysqli_query($koneksi,"SELECT barang.`id`,barang.`nama`, supplier.`nama` AS supplier, stok.`stok_masuk`, stok.`id`, stok.`stok_sekarang`,stok.`tanggal`,stok.`kadaluarsa`,stok.`harga`
FROM stok
JOIN barang
